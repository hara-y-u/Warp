    ...
    Warp.prototype.handleWebSocketMessage = function(msg, id) {
      ...
      if (msg.type === 'status') {
        if (msg.data === 'start') {
          ...
          if (this.lastCommand) return this.sendWebSocketMessage(this.lastCommand);
        }
      }
    };
